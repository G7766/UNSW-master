...
% agents current position, without reordering the current list of goals.
% 
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
% [PART 3]
% A predicate which takes the agents beliefs and the list of intentions,
...
% lists of beliefs and intentions resulting from the agents observations.
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
