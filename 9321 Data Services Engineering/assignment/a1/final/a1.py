...
if __name__ == '__main__':
    ...
    #df1.columns = ['index','Rubish','Number of Games the country participated in', 'Gold', 'Silver','Bronze','Total']
    #print(df1)
    ...
    #q1 merge two dataframe       (do not concatenate the datasets)?????
    #   and display the first five rows
    df = q1_merge(df1,df2)
    #df.to_csv('q1.csv')
    df_q1 =df.head(5)
    #df_q1.to_csv('q3.csv',index=None)
    #df_q1.to_csv('q3.csv')
    #print('Q1:\n',df_q1)
    print('Q1:\n')
