...
# show the trend of dog and cat by years
...
# shiw the trend of cat and dog group by their outcome type by year
...
# process all kinds of age types and change to days
def Age_process(dataframe):
    ...
    return dataframe
# use number to represent the color
def processcolor(data):
    ...
    print(head(data.color,10))
    return data

# use number to represent the sex type
...
# use number to represent outcome type 
# the good result is larger than bad result
