...
print(f'The mean is {the_mean:.2f}.')       #mean平均值
print(f'The median is {the_median:.2f}.')   #median中位数
print(f'The standard deviation is {the_standard_deviation:.2f}.') #standard 标准差
