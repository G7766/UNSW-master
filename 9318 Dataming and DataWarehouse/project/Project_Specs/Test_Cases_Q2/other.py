...
#
#z = top_k_viterbi(State_File, Symbol_File, Query_File, 3)
#for i in z:
#    print(z)
# Question 3 + Bonus
...
#aa = viterbi_algorithm(State_File, Symbol_File, Query_File)
#print(aa)
